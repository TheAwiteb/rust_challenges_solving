...
// +----------------------------------------+----------------------------------------+
// | Your task is to sort a given string. Each word in the string will contain a sin |
// | gle number. This number is the position the word should have in the result.     |
// |                                                                                 |
